...
const isLogin = getLocalStorageItem("jwt");
const NoFoundCart = "/assets/images/nofoundcart.png";

export default function CartModal({ name, CartCount, cartUpdate, ...props }) {
  ...
  useEffect(() => {
    // console.log('kkkkkk')
    // console.log(Cart_Data.cartdata.length)
