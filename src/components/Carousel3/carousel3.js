...
export default function Carousel3(props) {
  const [testimonialData, setTestmonialData] = useState(dataPairs)
    ...
    <section className="client py-4  pg-testimonials bg-light">
      <div className="container">
        <div className="text-center header-heading">
          <h1 className=" fw-bold text-dark" style={props?.fontSize}>{props?.heading}</h1>
        </div>
                ...
                testimonialData.map((item, index) => {
                  return (
                    <Carousel.Item key={index}>
                        <Carousel3Item value={item} key={index} />
                    </Carousel.Item>
                  );
                })}
            </Carousel>
...
const data = [
  {
    ...
    image: '/assets/images/Aman-Bansal.png',
  },
  {
    ...
    image: '/assets/images/dungara-ram.png'
  },
  {
    ...
    image: '/assets/images/Chitrang-Murdia.png'
  },
  {
    ...
    image: '/assets/images/Harshit-Chopra.png'
  },
  {
    ...
    image: '/assets/images/Kunal-Goyal.png'
  },
  {
    ...
    image: '/assets/images/luv-kumar.png'
  },
  {
    ...
    image: '/assets/images/navneet-loiwal.png'
  },
  {
    ...
    image: '/assets/images/rajhans-samdani.png'
  },
  {
    ...
    image: '/assets/images/gaurav-didwania.png'
  },
  {
    ...
    image: '/assets/images/Gaurav-Bubna.png'
  },
  {
    ...
    image: '/assets/images/Mehul-Kumar.png'
  },
]
...
// console.log(data.length)
  for (let i = 0; i < data.length ; i += 2) {
    dataPairs.push(data.slice(i, i + 2));
}
