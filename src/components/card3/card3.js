...
const image2 = "/assets/images/cg-1.png";
...
export default function Card3(props) {
  ...
  return (
    <>
      ...
      <div className="card vjed-card viewdetails-card-sticky  border-0 shadow radious_all" style={{position: 'sticky', top: '110px'}}>
        ...
        <p className="card-text vjed-text">Language: Mix (English & Hindi)</p> */}
          ...
          <div>
            {props.mrp != 0 && (
              ...
              <p>{props?.is_gst == 1 ? "GST Excluded" : "GST Included"}</p>
            )}
          </div>
