...
export default function TermCondition() {
  ...
  */
  ...
  //////////////Caching on termService (terms)////////////////////////

  const fetchTermsService = async () => {
      const responseTermsService = await termService()
      // console.log("responseTerms", responseTermsService)
      return responseTermsService.data
  }

  const {data : term_data, isFetched} = useQuery("terms_Service", fetchTermsService, {
